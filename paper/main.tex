...
Comparing the ensemble strategies, the Stacking Ensemble provided the highest macro F1-score and better false-positive control compared to the Soft Voting approach. Thus, the Stacking Ensemble combined with SMOTE-Tomek was selected as the primary model.
