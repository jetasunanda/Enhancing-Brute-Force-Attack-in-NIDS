...
The meaning of this pattern is that individual classifiers captured useful but different decision behavior. KNN was sensitive to Brute Force samples, but its high log loss of 0.4115 and lower macro F1-score of 65.65\% indicate weaker probability reliability and less consistent multiclass performance. This supports the motivation for ensemble learning in IDS, where diverse learners are combined to reduce dependence on the weaknesses of a single classifier \cite{farooqi2024enhancing,urmi2024stacked,alessa2024hybrid,pramanick2025stacking}. The implication is that strong individual validation scores are useful diagnostics, but they do not replace final ensemble evaluation on the unseen test set. Consequently, the final claims of this study should be interpreted as evidence for the proposed soft voting and stacking configurations rather than as a complete comparison of standalone classifiers.
